...
class Settings(BaseSettings):
    ...
    WATCHLIST_SYMBOLS: str = (
        "RELIANCE,TCS,HDFCBANK,INFY,ICICIBANK,SBIN,BHARTIARTL,LT,AXISBANK,ITC,"
        "BAJFINANCE,MARUTI,SUNPHARMA,TATAMOTORS,ADANIPORTS,TATASTEEL,ADANIENT,"
        "HAL,INDIGO,TATAPOWER,NIFTY50,BANKNIFTY,SENSEX"
    )
